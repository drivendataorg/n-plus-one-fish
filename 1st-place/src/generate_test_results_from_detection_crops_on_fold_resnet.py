...
weights = {
    1: '../output/checkpoints/classification/model_resnet50_cat_fold_1/checkpoint-005-0.1223.hdf5',
    2: '../output/checkpoints/classification/model_resnet50_cat_fold_2/checkpoint-006-0.1380.hdf5',
    3: '../output/checkpoints/classification/model_resnet50_cat_fold_3/checkpoint-005-0.1552.hdf5',
    4: '../output/checkpoints/classification/model_resnet50_cat_fold_4/checkpoint-005-0.1549.hdf5'
}
