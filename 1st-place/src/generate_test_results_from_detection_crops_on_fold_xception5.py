...
weights = {
    1: '../output/checkpoints/classification/model_xception_fold_1/checkpoint-005-0.1181.hdf5',
    2: '../output/checkpoints/classification/model_xception_fold_2/checkpoint-004-0.1564.hdf5',
    3: '../output/checkpoints/classification/model_xception_fold_3/checkpoint-005-0.1640.hdf5',
    4: '../output/checkpoints/classification/model_xception_fold_4/checkpoint-004-0.1657.hdf5'
}
        ...
        for fold in folds:
            ...
            cmd = ('python3 fish_classification.py generate_test_results_from_detection_crops_on_fold --fold {fold}'
                   ...
                   ' --classification_model={classification_model}').format(
                        ...
                        classification_model='xception5'
                    )
            print(cmd)
            os.system(cmd)
