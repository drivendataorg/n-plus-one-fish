...
- Neural net based on DenseNet121. Pretrained weights located in ../weights/ folder
- It train faster than UNET. ~1 day to complete. Can be run in parallel for 5 Folds on 5 GPUs (use FOLD_TO_CALC constant).
- You can skip this part if you already have models with name 'DENSENET_121_fold_*.h5' in ../models/ directory
'''
...
def train_single_classification_model_full_frame(cnn_type, num_fold, train_index, test_index, files):
    ...
    samples_train_per_epoch = 1200
    samples_valid_per_epoch = 1200
...
if __name__ == '__main__':
    run_cross_validation_create_models(5, 'DENSENET_121')
