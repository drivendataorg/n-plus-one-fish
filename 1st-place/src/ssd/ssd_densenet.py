...
def SSD_Densenet(input_shape, num_classes=2):
    ...
    densenet_head = ssd.densenet.create_dense_net(nb_classes=2, img_dim=input_shape, depth=depth,
    ...
    densenet_head.load_weights("/home/dmytro/data/DenseNet/weights/DenseNet-BC-100-12-CIFAR100-5.-0054-1.981.hdf5",
                               by_name=True)
...
if __name__=='__main__':
    model = SSDResnet50_BN((300, 512, 3), 2)
    model.summary()

    from keras.utils.visualize_util import plot
    plot(model, to_file='SSDResnet50_BN.png')
