...
weights = {
    1: '../output/checkpoints/classification/model_resnet50_mask_fold_1/checkpoint-011-0.1275.hdf5',
    2: '../output/checkpoints/classification/model_resnet50_mask_fold_2/checkpoint-014-0.1407.hdf5',
        ...
        for fold in folds:
            ...
            cmd = ('python3 fish_classification.py generate_test_results_from_detection_crops_on_fold --fold {fold}'
                   ...
                   ' --classification_model={classification_model}').format(
                        ...
                        classification_model='resnet50_mask'
                    )
            print(cmd)
            os.system(cmd)
